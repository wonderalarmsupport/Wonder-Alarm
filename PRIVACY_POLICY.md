...
The Application collects certain information automatically when you download and use it. This information may include:
...
* Your consent, where required and permitted


Data Disclosure
The Service Provider may disclose information:

* As required by law or legal process (such as a subpoena or court order)
* To protect rights, safety, or property
* To investigate fraud or security issues
* To respond to lawful requests by public authorities
* To trusted service providers who process data on behalf of the Service Provider under confidentiality obligations


Data Retention
The Service Provider retains data only as long as necessary:

* Automatically collected data (analytics, diagnostics): retained according to the policies of third-party providers
...
Security
The Service Provider implements reasonable technical and organizational measures to protect your information.


Data Breach Notification
In the event of a data breach affecting your personal data, the Service Provider will notify users as required by applicable law.
